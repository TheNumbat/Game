...
void gamestart(engine_state* engine, game_state* game)
{
	...
	texture.lock()->addTexture("glow","light",rect2<real32>(-3.5,-3.5,7,7),rect2<int32>(0,0,0,0),0,blend_additive);
	...
	testtexture.lock()->addTexture("main","yeti",rect2<real32>(-0.5,-0.5,1,1),rect2<int32>(0,0,0,0),1);
